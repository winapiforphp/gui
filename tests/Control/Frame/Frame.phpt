--TEST--
Win\Gui\Control\Frame Reflection
--SKIPIF--
<?php
...
--FILE--
<?php
ReflectionClass::export('Win\Gui\Control\Frame');
?>
--EXPECT--
Class [ <internal:wingui> class Win\Gui\Control\Frame extends Win\Gui\Control implements Win\Gui\Messaging ] {
  ...
  - Constants [40] {
    ...
    Constant [ integer FRAME_COLOR ] { 1 }
    Constant [ integer WINDOW_COLOR ] { 2 }
    Constant [ integer BACKGROUND_COLOR ] { 3 }
    Constant [ integer ETCHED ] { 4 }
    Constant [ integer ETCHED_HORZ ] { 5 }
    Constant [ integer ETCHED_VERT ] { 6 }
  }
  ...
  - Properties [10] {
    ...
    Property [ <default> public $filled ]
    Property [ <default> public $color ]
  }
  ...
  - Methods [28] {
    Method [ <internal:wingui, overwrites Win\Gui\Control, ctor> public method __construct ] {
      ...
      - Parameters [4] {
        ...
        Parameter #1 [ <optional> $filled ]
        Parameter #2 [ <optional> $color ]
